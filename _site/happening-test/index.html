...
<title>What's Happening Test</title>
...
<div id="rbgdefaultbody" class="container-fluid">
  <div class="row">
  	  <div class="col-sm-12">
  	  	...
  	  	<div class="rbgbanner"><img src="/images/banners/whats-happening-fall.jpg"></div>
  	  	
  	  	<br />
  	  	
        <h2>What's Happening Test</h2>
        <h5>Submitted October 30, 2016 at 9:43 AM </h5>
