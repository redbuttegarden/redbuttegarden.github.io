...
<title>What's Happening Blog</title>
...
<div class="row-fluid">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		<a href="/happening-test/">
		<div class="eventwrapsmall hover">
		
			<img src="/images/events/">
			
			<div class="eventinfo">
				<div class="eventname">What's Happening Test</div>
				<div class="eventdate">October 30, 2016</div>
			</div>
...
<br />
    ...
    <li><a href="/happening-test/">What's Happening Test</a></li>
  </ul>
...
function getBanner() {
	...
	if ( (month == 9) || (month == 10 ) || (month == 11) ) {
		document.getElementById('blog-banner').src='/images/banners/whats-happening-fall.jpg';
	}
	
	if ( (month == 12) || (month == 1 ) || (month == 2) ) {
		document.getElementById('blog-banner').src='/images/banners/whats-happening-winter.jpg';
	}
	
	if ( (month == 3) || (month == 4 ) || (month == 5) ) {
		document.getElementById('blog-banner').src='/images/banners/whats-happening-spring.jpg';
	}
