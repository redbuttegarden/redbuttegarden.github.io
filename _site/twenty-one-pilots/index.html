...
<!-- Begin First Column -->
	<div class="row-fluid">
		...
		<div class="col-sm-3">
			...
			<!-- Event Picture-->
			<div class="event-pic">
				<img src="/images/events/twentyonepilots.jpg">
			</div>

			<div class="ev-title-mobile">
				<br />
		  	  	<div class="ev-title caps">TWENTY ØNE PILØTS</div>
		  	  	<div class="ev-sub">Tyler Joseph and Josh Dun</div>
	  	  	</div>
			...
			<a class="ev-ticket-link" href="">
					<div class="ev-tickets hover /images/buy-tickets.png "><img src="/images/buy-tickets.png" class="responsive" width="100%" /></div>
			</a>

			<!-- Calendar code for if we ever upload .ics files

			<a class="ev-cal-link" href="/events/ics/christmas.ics">
			...
			<div class="ev-location">Red Butte Garden Amphitheatre</div>
			...
			<div>
				...
				<div class="ev-member-sale">April 25</div>
			</div>

			<div>
				<div class="inline">General Public On Sale -&nbsp;</div>
				<div class="ev-public-sale">May 2</div>
			</div>
			...
			<div>
				...
				<div class="ev-member-cost">21.21</div>
			</div>

			<div>
				<div class="inline">General Public:&nbsp;</div>
				<div class="ev-public-cost">210.21</div>
			</div>
...
<!-- Begin Second Column -->
  	  ...
  	  <div class="col-sm-9">
  	  	...
  	  	<div class="ev-title-reg">
	  	  	<div class="ev-title">TWENTY ØNE PILØTS</div>
	  	  	<div class="ev-sub">Tyler Joseph and Josh Dun</div>
  	  	</div>

  	  	<br />

  	  	<div class="ev-date">FRIDAY, July 21 @ 9:00PM</div>
