...
<title>Summer Events | Red Butte Garden</title>
...
<div class="row-fluid">
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
		<a href="/twenty-one-pilots/">
		<div class="eventwrapsmall hover">
		
			<img src="../images/events/twentyonepilots.jpg">
			
			<div class="eventinfo">
				<div class="eventname">TWENTY ØNE PILØTS</div>
				<div class="eventdate">FRIDAY, July 21 @ 9:00PM</div>
				<div class="eventnotes">TWENTY ØNE PILØTS HAVE THEIR BIGGEST SHØW ØF THE SEASØN!</div>
			</div>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
		<a href="/spyhop-heatwave/">
		<div class="eventwrapsmall hover">
		
			<img src="../images/events/spyhop-heatwave.jpg">
			
			<div class="eventinfo">
				<div class="eventname">SPY HOP PRESENTS: HEATWAVE FESTIVAL</div>
				<div class="eventdate">MONDAY, JULY 18 @ 7PM</div>
				<div class="eventnotes">free admission</div>
			</div>
	...
	<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
		...
		<div class="eventwrapsmall hover">
			...
			<div class="eventinfo">
				<div class="eventname">SUNDANCE INSTITUTE SUMMER FILM SERIES</div>
				<div class="eventdate">JULY & AUGUST</div>
				<div class="eventnotes">free admission</div>
			</div>
