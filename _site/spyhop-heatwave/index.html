...
<title>SPY HOP PRESENTS: HEATWAVE FESTIVAL</title>
...
<!-- Begin First Column -->
	<div class="row-fluid">
		...
		<div class="col-sm-3">
			...
			<!-- Event Picture-->
			<div class="event-pic">
				<img src="/images/events/spyhop-heatwave.jpg">
			</div>

			<div class="ev-title-mobile">
				<br />
		  	  	<div class="ev-title caps">SPY HOP PRESENTS: HEATWAVE FESTIVAL</div>
		  	  	<div class="ev-sub">free concert</div>
	  	  	</div>
...
<!-- Begin Second Column -->
  	  ...
  	  <div class="col-sm-9">
  	  	...
  	  	<div class="ev-title-reg">
	  	  	<div class="ev-title">SPY HOP PRESENTS: HEATWAVE FESTIVAL</div>
	  	  	<div class="ev-sub">free concert</div>
  	  	</div>

  	  	<br />

  	  	<div class="ev-date">MONDAY, JULY 18 @ 7PM</div>
