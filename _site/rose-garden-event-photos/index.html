...
<title>Rose Garden Event Photos</title>
...
<div id="rbgdefaultbody" class="container-fluid">
  <div class="row">
	...
	<hr>
		<div class="grid-header">ROSE GARDEN EVENT PHOTOS</div>		
	<hr>
</div>
...
<div class="container">
  ...
  <div id="rbgCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
	  ...
	  <div class="item">
        <img src="/images/misc/rose-garden-event.jpg" alt="Rose Garden Event" title="Rose Garden Event" />
      </div>
