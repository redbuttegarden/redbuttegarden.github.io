...
<title>Garden Poetry Reading</title>
	...
	<div class="row-fluid">
		...
		<div class="col-sm-3">
			...
			<div class="ev-title-mobile">
				<br />
		  	  	<div class="ev-title caps">Garden Poetry Reading</div>
		  	  	<div class="ev-sub"></div>
	  	  	</div>

	  	  	<div class="ev-date-mobile">
				TUESDAY, APRIL 26 @ 6-7PM
			</div>

			<a class="ev-ticket-link" href="">
					<div class="ev-tickets hover register "><img src="register" class="responsive" width="100%" /></div>
			</a>
			...
			<div>
				...
				<div class="ev-public-cost">Garden Admission</div>
			</div>
...
<!-- Begin Second Column -->
  	  ...
  	  <div class="col-sm-9">
  	  	...
  	  	<div class="ev-title-reg">
	  	  	<div class="ev-title">Garden Poetry Reading</div>
	  	  	<div class="ev-sub"></div>
  	  	</div>

  	  	<br />

  	  	<div class="ev-date">TUESDAY, APRIL 26 @ 6-7PM</div>
