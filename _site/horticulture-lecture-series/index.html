...
<title>FREE HORTICULTURE SPOTLIGHT LECTURE SERIES</title>
	...
	<div class="row-fluid">
		...
		<div class="col-sm-3">
			...
			<div class="ev-title-mobile">
				<br />
		  	  	<div class="ev-title caps">FREE HORTICULTURE SPOTLIGHT LECTURE SERIES</div>
		  	  	<div class="ev-sub">five free and interesting lectures to choose from</div>
	  	  	</div>

	  	  	<div class="ev-date-mobile">
				VARIOUS DATES MAY 16-SEPTEMBER 19
			</div>

			<a class="ev-ticket-link" href="">
					<div class="ev-tickets hover  "><img src="" class="responsive" width="100%" /></div>
			</a>

			<!-- Calendar code for if we ever upload .ics files

			<a class="ev-cal-link" href="/events/ics/">
				<div class="ev-cal hover calendar "></div>
			</a>
			...
			<div class="ev-location">Red Butte Garden Visitor Center</div>
			...
			<div>
				...
				<div class="ev-member-sale">N/A</div>
			</div>

			<div>
				<div class="inline">General Public On Sale -&nbsp;</div>
				<div class="ev-public-sale">N/A</div>
			</div>
			...
			<div>
				...
				<div class="ev-member-cost">Free</div>
			</div>

			<div>
				<div class="inline">General Public:&nbsp;</div>
				<div class="ev-public-cost">Free</div>
			</div>
...
<!-- Begin Second Column -->
  	  ...
  	  <div class="col-sm-9">
  	  	...
  	  	<div class="ev-title-reg">
	  	  	<div class="ev-title">FREE HORTICULTURE SPOTLIGHT LECTURE SERIES</div>
	  	  	<div class="ev-sub">five free and interesting lectures to choose from</div>
  	  	</div>

  	  	<br />

  	  	<div class="ev-date">VARIOUS DATES MAY 16-SEPTEMBER 19</div>
