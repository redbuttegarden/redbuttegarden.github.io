...
<title>WILLIE NELSON & FAMILY</title>
...
<!-- Begin First Column -->
	<div class="row-fluid">
		...
		<div class="col-sm-3">
			...
			<!-- Event Picture-->
			<div class="event-pic">
				<img src="/images/events/concert-images/11.jpg">
			</div>

			<div class="ev-title-mobile">
				<br />
		  	  	<div class="ev-title caps">WILLIE NELSON & FAMILY</div>
		  	  	<div class="ev-sub">with special guest Tony Holiday</div>
	  	  	</div>
			...
			<div>
				...
				<div class="ev-member-cost">72</div>
			</div>

			<div>
				<div class="inline">General Public:&nbsp;</div>
				<div class="ev-public-cost">77</div>
			</div>
...
<!-- Begin Second Column -->
  	  ...
  	  <div class="col-sm-9">
  	  	...
  	  	<div class="ev-title-reg">
	  	  	<div class="ev-title">WILLIE NELSON & FAMILY</div>
	  	  	<div class="ev-sub">with special guest Tony Holiday</div>
  	  	</div>

  	  	<br />

  	  	<div class="ev-date">THURSDAY, July 28 @ 7:30PM</div>
